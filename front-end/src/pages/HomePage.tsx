    ...
    <main className="flex flex-col items-center justify-center min-h-[90vh] bg-white py-8 px-4">
      ...
      <section className="bg-gray-200 p-6 md:p-8 rounded-2xl shadow-md max-w-4xl w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          ...
          <Link
            to={"/cadastro"}
            className="group bg-white p-6 rounded-xl shadow-md flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-2.5 hover:shadow-xl border border-gray-100"
          >
